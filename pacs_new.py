...
label_dom1=[]
class_names1=[]
path_dom1='/home/1098363-z100/nfs/users/Singha/testodg/data/pacs/'+domains[0]
...
label_dom2=[]
class_names2=[]
path_dom2='/home/1098363-z100/nfs/users/Singha/testodg/data/pacs/'+domains[1]
...
label_dom3=[]
class_names3=[]
path_dom3='/home/1098363-z100/nfs/users/Singha/testodg/data/pacs/'+domains[2]
...
train_model = CustomCLIP(train_classnames, clip_model).to(device)
...
test_label_dom=[]
test_domain_names=[]
test_path_dom='/home/1098363-z100/nfs/users/Singha/testodg/data/pacs/'+domains[3]
...
best_open_set_acc = 0
best_avg_acc = 0
accuracy_file_path = "/home/1098363-z100/nfs/users/Singha/testodg/results/pacs/sketch.txt"  
...
for epoch in range(2):
    ...
    TRAIN_MODEL_PATH = Path("/home/1098363-z100/nfs/users/Singha/testodg/train_models/pacs/sketch")
    ...
    MODEL_PATH = "/home/1098363-z100/nfs/users/Singha/testodg/train_models/pacs/sketch"
    ...
    with torch.no_grad():
        ...
        if average_acc > best_avg_acc:
            ...
            TEST_MODEL_PATH = Path("/home/1098363-z100/nfs/users/Singha/testodg/test_models/pacs")
