...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image, label):
        ...
        print(matched_texts.shape)

        self.upsample_net = self.upsample_net.to(device)
        upsampled_texts = self.upsample_net(matched_texts)
        #matched_texts = matched_texts.unsqueeze(1).unsqueeze(1)
        # print(upsampled_texts.shape)
        # print(matched_texts.shape)
        # exit()
        target_size = (224, 224)
        ...
        # '''
        # generated_output_directory5 = '/home/dgxadmin/Ankit/ODG/generated_images/pacs/cartoon_xtilde/x_tilde_images'
        ...
        generated_images_pil5 = [TF.to_pil_image(img) for img in final_image]
        for i, img_pil in enumerate(generated_images_pil5):
           img_pil.save(os.path.join(generated_output_directory5, f"{i}_xtilde_image.jpg"))
        ...
        '''
        generated_output_directory6 = '/home/dgxadmin/Ankit/ODG/generated_images/pacs/cartoon_xtilde/x_tilde_normalizedimages'
        ...
        for i, img_pil in enumerate(generated_images_pil6):
           img_pil.save(os.path.join(generated_output_directory6, f"{i}_xtilde_normalizedimage.jpg"))
