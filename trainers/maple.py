...
class MultiModalPromptLearner(nn.Module):
    def __init__(self, classnames, clip_model):
        ...
        assert 9 >= 1, "For MaPLe, PROMPT_DEPTH should be >= 1"
    ...
    def forward(self):
        ...
        return prompts, self.proj(self.ctx.to(torch.float16)).to(torch.float32), self.compound_prompts_text, visual_deep_prompts   # pass here original, as for visual 768 is required
