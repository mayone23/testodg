...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image, label):
        ...
        #rescaled_image = normalize(image)
        ...
        l2_normproj2 = torch.linalg.norm(class_textfeatures, dim=1, ord=2)
        l2_normproj2 = l2_normproj2.unsqueeze(1)
        class_textfeatures=class_textfeatures/l2_normproj2
        class_textfeatures=class_textfeatures/class_textfeatures.norm(dim=-1,keepdim=True)
        #print(torch.mean(F.cosine_similarity(diff_projfeatures,class_textfeatures,dim=0)))
        #exit()
